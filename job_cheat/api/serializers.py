...
class FirebaseUserSerializer(serializers.Serializer):
    ...
    photo_url = serializers.URLField(allow_null=True, allow_blank=True, required=False)
    email_verified = serializers.BooleanField(allow_null=True, required=False)
    provider_id = serializers.CharField(allow_null=True, allow_blank=True, required=False)
